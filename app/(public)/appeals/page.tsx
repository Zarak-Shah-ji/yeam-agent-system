        ...
        <div className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-14">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white shadow-lg shadow-black/20 ring-1 ring-white/10">
              <Image src="/logo.png" alt="Yeam.ai" width={36} height={36} className="h-9 w-9 object-contain" />
            </div>
            <div>
          ...
          <h1 className="mt-8 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
            AI-drafted insurance appeals
          </h1>
          <p className="mt-3 max-w-xl text-base text-slate-300">
            Below are appeal letters Yeam generated automatically from denied claims. You can
            also upload one of your own denial documents and get a letter back in seconds.
          </p>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-14">
        <section>
          <h2 className="text-xl font-semibold tracking-tight text-gray-900">
            Recent AI-drafted appeals
          </h2>
          <p className="mt-1 text-sm text-gray-600">
            Generated by the billing agent from live claim data — patient details are synthetic.
          </p>
